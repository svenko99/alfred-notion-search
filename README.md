...
1. Install [⤓ Notion Search Workflow](https://github.com/svenko99/alfred-notion/raw/main/notion_search.alfredworkflow) in the repo. You will be asked to put `Notion API key (of the integration)`. Follow steps in `2.` to get the API key.
